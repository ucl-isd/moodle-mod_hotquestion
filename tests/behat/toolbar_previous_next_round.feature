@mod @mod_hotquestion
Feature: Users can view previous and next rounds
  In order to view previous and next rounds
  As a user
  I need to follow previous and next round toolbuttons
  ...
  Scenario: A user follows previous and next toolbuttons to view other rounds
